...
#define full_steps_per_rotation 200 //1.8 deg per full step, 360/1.8=200
...
void setStepperDefaults(int x){
    cricketFeeder[x].setMaxSpeed(400.0); //200 is default
    cricketFeeder[x+2].setMaxSpeed(400.0); //200 is default,
    cricketFeeder[x].setAcceleration(200.0); //100 is default
    cricketFeeder[x+2].setAcceleration(200.0); //100 is default
}
